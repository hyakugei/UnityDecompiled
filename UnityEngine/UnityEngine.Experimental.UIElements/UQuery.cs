	...
	public static class UQuery
	{
		...
		public struct QueryBuilder<T> where T : VisualElement
		{
			...
			private List<StyleSelector> styleSelectors
			{
				get
				{
					List<StyleSelector> arg_1C_0;
					if ((arg_1C_0 = this.m_StyleSelectors) == null)
					{
						arg_1C_0 = (this.m_StyleSelectors = new List<StyleSelector>());
					}
					return arg_1C_0;
				}
			}
			...
			private List<StyleSelectorPart> parts
			{
				get
				{
					List<StyleSelectorPart> arg_1C_0;
					if ((arg_1C_0 = this.m_Parts) == null)
					{
						arg_1C_0 = (this.m_Parts = new List<StyleSelectorPart>());
					}
					return arg_1C_0;
				}
			}
			...
			private UQuery.QueryBuilder<T2> AddRelationship<T2>(StyleSelectorRelationship relationship) where T2 : VisualElement
			{
				...
				result.m_Relationship = relationship;
