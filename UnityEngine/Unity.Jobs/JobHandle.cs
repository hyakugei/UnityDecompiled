...
namespace Unity.Jobs
{
	...
	public struct JobHandle
	{
		...
		[MethodImpl(MethodImplOptions.InternalCall)]
		private static extern void ScheduleBatchedJobsAndCompleteAll(IntPtr jobs, int count);
		...
		private static JobHandle CombineDependenciesInternalPtr(IntPtr jobs, int count)
		{
			JobHandle result;
		...
		[MethodImpl(MethodImplOptions.InternalCall)]
		private static extern void CombineDependenciesInternalPtr_Injected(IntPtr jobs, int count, out JobHandle ret);
