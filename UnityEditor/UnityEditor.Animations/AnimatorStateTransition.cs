...
namespace UnityEditor.Animations
{
	public class AnimatorStateTransition : AnimatorTransitionBase
	{
		...
		{
			AnimatorStateTransition.Internal_CreateAnimatorStateTransition(this);
		}

		[MethodImpl(MethodImplOptions.InternalCall)]
		private static extern void Internal_CreateAnimatorStateTransition([Writable] AnimatorStateTransition self);
	}
}
