...
namespace UnityEditor
{
	...
	internal class CanvasEditor : Editor
	{
		...
		{
			public static GUIContent eventCamera = EditorGUIUtility.TrTextContent("Event Camera", "The Camera which the events are triggered through. This is used to determine clicking and hover positions if the Canvas is in World Space render mode.", null);

			public static GUIContent renderCamera = EditorGUIUtility.TrTextContent("Render Camera", "The Camera which will render the canvas. This is also the camera used to send events.", null);

			public static GUIContent sortingOrder = EditorGUIUtility.TrTextContent("Sort Order", "The order in which Screen Space - Overlay canvas will render", null);
			...
			public static GUIContent targetDisplay = EditorGUIUtility.TrTextContent("Target Display", "Display on which to render the canvas when in overlay mode", null);
			...
			public static GUIContent m_ShaderChannel = EditorGUIUtility.TrTextContent("Additional Shader Channels", null, null);
		}
