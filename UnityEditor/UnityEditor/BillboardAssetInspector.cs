...
namespace UnityEditor
{
	...
	internal class BillboardAssetInspector : Editor
	{
		...
		{
			public readonly GUIContent m_Shaded = EditorGUIUtility.TrTextContent("Shaded", null, null);

			public readonly GUIContent m_Geometry = EditorGUIUtility.TrTextContent("Geometry", null, null);
		...
		private void DoRenderPreview(bool shaded)
		{
			...
			if (shaded)
			{
				...
				billboardAsset.MakeMaterialProperties(this.m_ShadedMaterialProperties, this.m_PreviewUtility.camera);
