...
namespace UnityEditor
{
	...
	public class GridBrushEditor : GridBrushEditorBase
	{
		...
		{
			public static readonly GUIContent multieditingNotSupported = EditorGUIUtility.TrTextContent("Multi-editing cells not supported", null, null);

			public static readonly GUIContent tileLabel = EditorGUIUtility.TrTextContent("Tile", "Tile set in tilemap", null);

			public static readonly GUIContent spriteLabel = EditorGUIUtility.TrTextContent("Sprite", "Sprite set when tile is set in tilemap", null);

			public static readonly GUIContent colorLabel = EditorGUIUtility.TrTextContent("Color", "Color set when tile is set in tilemap", null);

			public static readonly GUIContent gameObjectLabel = EditorGUIUtility.TrTextContent("GameObject", "Game Object instantiated when tile is set in tilemap", null);

			public static readonly GUIContent colliderTypeLabel = EditorGUIUtility.TrTextContent("Collider Type", "Collider shape used for tile", null);

			public static readonly GUIContent gridPositionLabel = EditorGUIUtility.TrTextContent("Grid Position", "Position of the tile in the tilemap", null);

			public static readonly GUIContent lockColorLabel = EditorGUIUtility.TrTextContent("Lock Color", "Prevents tilemap from changing color of tile", null);

			public static readonly GUIContent lockTransformLabel = EditorGUIUtility.TrTextContent("Lock Transform", "Prevents tilemap from changing transform of tile", null);

			public static readonly GUIContent instantiateGameObjectRuntimeOnlyLabel = EditorGUIUtility.TrTextContent("Instantiate GameObject Runtime Only", "Instantiates GameObject in runtime play mode only", null);

			public static readonly GUIContent floodFillPreviewLabel = EditorGUIUtility.TrTextContent("Show Flood Fill Preview", "Whether a preview is shown while painting a Tilemap when Flood Fill mode is enabled", null);
